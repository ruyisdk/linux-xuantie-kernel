...
#ifndef __CANAAN_DESIGNWARE_LOCAL_H
#define __CANAAN_DESIGNWARE_LOCAL_H
...
#if IS_ENABLED(CONFIG_CANAAN_SND_DESIGNWARE_PCM)
void canaan_dw_pcm_push_tx(struct dw_i2s_dev *dev);
void canaan_dw_pcm_pop_rx(struct dw_i2s_dev *dev);
int canaan_dw_pcm_register(struct platform_device *pdev);
#else
