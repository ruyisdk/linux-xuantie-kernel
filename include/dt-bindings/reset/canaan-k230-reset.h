 ...
 * 3. reset在一个寄存器中，done在另一个寄存器中
 * (只有一个，即cpu1_preset_req在0x4中，cpu1_prst_done在0xc中)，
...
// cpu0_preset_req(cpu0_rst_done)、cpu1_preset_req(cpu1_rst_done)、
//tdi_preset_req(tdi_rst_done)用于调试
// /* cpu0 apb reset */
