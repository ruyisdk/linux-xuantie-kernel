 ...
 */
struct kendryte_rsa_mprog_cmac_st {
	const void *prk;
	const void *puk;
};
 ...
 */
struct kendryte_rsa_mprog_func_st {
	const void *prk;
	const void *puk;
};
 ...
 */
struct kendryte_rsa_mprog_st {
	struct kendryte_rsa_mprog_cmac_st **cmac;
	struct kendryte_rsa_mprog_func_st *func;
};

enum kendryte_ecp_field_t {
	P1024 = 0x85,
	P2048,
	P3072,
	P4096,
...
enum kendryte_ecp_version_t {
	ECP_UNSUPPORTED = -1,
	ECP_ECF39303,
	ECP_ECF09303,
};

enum kendryte_mp_version_t {
	MP_UNSUPPORTED = -1,
	MP_00000000,
	MP_3EE2DE76,
};
...
struct kendryte_rsa_ctx {
	...
	enum kendryte_rsa_type_t rsatype;
};
