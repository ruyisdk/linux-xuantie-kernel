...
static void read_ecp_operand(struct kendryte_rsa_ctx *ctx, uint32_t pos,
			     uint8_t *res, uint32_t elen)
{
	uint32_t wlen = ((elen + 3) / 4) * 4;
	uint32_t rlen = wlen;

	rsa_memcpy(pkc_buffer,
		   (uint8_t *)(ctx->dev->base + ECP_DATA_OFFSET) + wlen * pos,
		   rlen);
	reverse(res, pkc_buffer, elen);
}

static void write_ecp_operand(struct kendryte_rsa_ctx *ctx, uint32_t pos,
			      const uint8_t *op, uint32_t elen)
{
	uint32_t wlen = ((elen + 3) / 4) * 4;
	...
	rsa_memcpy((uint8_t *)(ctx->dev->base + ECP_DATA_OFFSET) + wlen * pos,
		   pkc_buffer, wlen);
}

static enum kendryte_status_t
rsa_get_field_elen(enum kendryte_ecp_field_t *field, uint32_t *elen,
		   enum kendryte_rsa_type_t rsatype)
{
	enum kendryte_ecp_field_t rf;
	uint32_t rl;
 ...
 */
static struct kendryte_rsa_mprog_func_st prog_ECF39303_RSA1024 = {
	.prk = "\x40\x00\x00\x8a\x60\x40\x04\x0a\x80\x80\x08\x8a\xa0\xc0\x0c\x0a"
	       "\x00\x04\x11\x26\x40\x40\x15\x26\x00\x0c\x80\x43\x66\x10\x10\x88"
	       ...
	       "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
	       "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00",
	.puk = "\x40\x00\x00\x8a\x80\x80\x08\x8a\x00\x0b\x80\xc3\x66\x10\x10\x88"
	       "\x00\x00\x00\xfc\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
	       "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
	       "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
	       "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
...
static struct kendryte_rsa_mprog_func_st prog_ECF39303_RSA2048 = {
	.prk = "\x40\x00\x00\x8a\x80\x40\x08\x8a\xc0\x80\x10\x0a\x00\xc1\x18\x8a"
	       "\x00\x08\x21\x26\x40\x40\x29\x26\x00\x0c\x80\x43\xc6\x10\x18\x08"
	       "\x00\x00\x00\xfc\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
	       "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
	       "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
	       "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
	       ...
	       "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
	       "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00",
	.puk = "\x40\x00\x00\x8a\xc0\x80\x10\x0a\x00\x0b\x80\xc3\xc6\x10\x18\x08"
	       "\x00\x00\x00\xfc\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
	       "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
	       "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
	       "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
...
static struct kendryte_rsa_mprog_func_st prog_ECF39303_RSA3072 = {
	.prk = "\x40\x00\x00\x8a\xa0\x40\x0c\x8a\x00\x81\x18\x0a\x60\xc1\x24\x8a"
	       "\x00\x0c\x31\x26\x40\x40\x3d\x26\x00\x0c\x80\x43\x26\x11\x20\x88"
	       "\x00\x00\x00\xfc\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
	       "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
	       "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
	       "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
	       ...
	       "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
	       "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00",
	.puk = "\x40\x00\x00\x8a\x00\x81\x18\x0a\x00\x0b\x80\xc3\x26\x11\x20\x88"
	       "\x00\x00\x00\xfc\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
	       "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
	       "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
	       "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
...
static struct kendryte_rsa_mprog_func_st prog_ECF39303_RSA4096 = {
	.prk = "\x40\x00\x00\x8a\xc0\x40\x10\x0a\x40\x81\x20\x0a\xc0\xc1\x30\x8a"
	       "\x00\x10\x41\x26\x40\x40\x51\x26\x00\x0c\x80\x43\x86\x11\x28\x08"
	       "\x00\x00\x00\xfc\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
	       "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
	       "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
	       "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
	       ...
	       "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
	       "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00",
	.puk = "\x40\x00\x00\x8a\x40\x81\x20\x0a\x00\x0b\x80\xc3\x86\x11\x28\x08"
	       "\x00\x00\x00\xfc\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
	       "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
	       "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
	       "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
 ...
 */
static struct kendryte_rsa_mprog_func_st prog_ECF09303_RSA1024 = {
	.prk = "\x88\x00\x00\x8e\x40\x00\x00\x8a\x80\x80\x08\x8a\xa0\x40\x04\x0a"
	       "\x00\x04\x11\x26\x40\x40\x15\x26\x00\x0c\x80\x43\x66\x10\x10\x88"
	       "\x00\x00\x00\xfc\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
	       "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
	       "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
...
static struct kendryte_rsa_mprog_func_st prog_ECF09303_RSA2048 = {
	.prk = "\x08\x01\x00\x8e\x40\x00\x00\x8a\xc0\x80\x10\x0a\x00\x41\x08\x8a"
	       "\x00\x08\x21\x26\x40\x40\x29\x26\x00\x0c\x80\x43\xc6\x10\x18\x08"
	       "\x00\x00\x00\xfc\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
	       "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
	       "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
...
static struct kendryte_rsa_mprog_func_st prog_ECF09303_RSA3072 = {
	.prk = "\x88\x01\x00\x0e\x40\x00\x00\x8a\x00\x81\x18\x0a\x60\x41\x0c\x0a"
	       "\x00\x0c\x31\x26\x40\x40\x3d\x26\x00\x0c\x80\x43\x26\x11\x20\x88"
	       "\x00\x00\x00\xfc\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
	       "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
	       "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
...
static struct kendryte_rsa_mprog_func_st prog_ECF09303_RSA4096 = {
	.prk = "\x08\x02\x00\x8e\x40\x00\x00\x8a\x40\x81\x20\x0a\xc0\x41\x10\x8a"
	       "\x00\x10\x41\x26\x40\x40\x51\x26\x00\x0c\x80\x43\x86\x11\x28\x08"
	       "\x00\x00\x00\xfc\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
	       "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
	       "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
 ...
 */
static struct kendryte_rsa_mprog_cmac_st sum_ECF39303_00000000_RSA1024 = {
...
static struct kendryte_rsa_mprog_cmac_st sum_ECF39303_00000000_RSA2048 = {
...
static struct kendryte_rsa_mprog_cmac_st sum_ECF39303_00000000_RSA3072 = {
...
static struct kendryte_rsa_mprog_cmac_st sum_ECF39303_00000000_RSA4096 = {
 ...
 */
static struct kendryte_rsa_mprog_cmac_st sum_ECF09303_00000000_RSA1024 = {
...
static struct kendryte_rsa_mprog_cmac_st sum_ECF09303_00000000_RSA2048 = {
...
static struct kendryte_rsa_mprog_cmac_st sum_ECF09303_00000000_RSA3072 = {
...
static struct kendryte_rsa_mprog_cmac_st sum_ECF09303_00000000_RSA4096 = {
 ...
 */
static struct kendryte_rsa_mprog_cmac_st *gsum_ECF39303_RSA1024[] = {
	&sum_ECF39303_00000000_RSA1024,
};

static struct kendryte_rsa_mprog_cmac_st *gsum_ECF39303_RSA2048[] = {
	&sum_ECF39303_00000000_RSA2048,
};

static struct kendryte_rsa_mprog_cmac_st *gsum_ECF39303_RSA3072[] = {
	&sum_ECF39303_00000000_RSA3072,
};

static struct kendryte_rsa_mprog_cmac_st *gsum_ECF39303_RSA4096[] = {
 ...
 */
static struct kendryte_rsa_mprog_cmac_st *gsum_ECF09303_RSA1024[] = {
	&sum_ECF09303_00000000_RSA1024,
};

static struct kendryte_rsa_mprog_cmac_st *gsum_ECF09303_RSA2048[] = {
	&sum_ECF09303_00000000_RSA2048,
};

static struct kendryte_rsa_mprog_cmac_st *gsum_ECF09303_RSA3072[] = {
	&sum_ECF09303_00000000_RSA3072,
};

static struct kendryte_rsa_mprog_cmac_st *gsum_ECF09303_RSA4096[] = {
	&sum_ECF09303_00000000_RSA4096,
};

struct kendryte_rsa_mprog_st rsa_ECF39303[] = {
	{
...
struct kendryte_rsa_mprog_st rsa_ECF09303[] = {
	{
...
struct kendryte_rsa_mprog_st *rsa_mprog[] = {
	rsa_ECF39303,
	rsa_ECF09303,
};
...
static int kendryte_rsa_sign(struct skcipher_request *req)
{
	...
	enum kendryte_ecp_field_t field;
	enum kendryte_status_t check = SUCCESS;
	void *buf_src, *buf_dst;
	const void *n, *priv, *msg;
	uint32_t puk;
	enum kendryte_rsa_type_t rsatype;
	enum kendryte_ecp_version_t ecp_version = ECP_ECF39303;
	enum kendryte_mp_version_t mp_version = MP_00000000;
	uint8_t out[PKC_BUFFER_SIZE];
	int ret = 0;

	check = rsa_get_field_elen(&field, &elen, ctx->rsatype);
	if (check != SUCCESS)
		goto rsa_err;
	...
	if ((n == NULL) || (puk == 0) || (priv == NULL) || (msg == NULL)) {
		check = E_INVALID;
		goto rsa_err;
	}
	...
	struct kendryte_rsa_mprog_st *prog = &(rsa_mprog[ecp_version][rsatype]);
	struct kendryte_rsa_mprog_cmac_st *cmac = prog->cmac[mp_version];

	rsa_memcpy((void *)(ctx->dev->base + ECP_MAC_OFFSET), cmac->prk,
		   ECP_MPMAC_SIZE);
	rsa_memcpy((void *)(ctx->dev->base + ECP_PROGRAM_OFFSET),
		   prog->func->prk, ECP_MPROG_SIZE);
...
static int kendryte_rsa_verify(struct skcipher_request *req)
{
	...
	rsa_memcpy((void *)(ctx->dev->base + ECP_MAC_OFFSET), cmac->puk,
		   ECP_MPMAC_SIZE);
	rsa_memcpy((void *)(ctx->dev->base + ECP_PROGRAM_OFFSET),
		   prog->func->puk, ECP_MPROG_SIZE);
...
static int kendryte_rsa_setkey(struct crypto_skcipher *tfm, const uint8_t *key,
			       unsigned int keylen)
{
	struct kendryte_rsa_ctx *ctx = crypto_skcipher_ctx(tfm);
	int len = 0;
...
static struct skcipher_alg
	kendryte_rsa_alg = { .encrypt = kendryte_rsa_verify,
			     ...
			     .base = {
				     ...
				     .cra_blocksize = 64,
				     .cra_ctxsize =
					     sizeof(struct kendryte_rsa_ctx),
...
static struct platform_driver
	kendryte_rsa_driver = { .probe = kendryte_rsa_probe,
