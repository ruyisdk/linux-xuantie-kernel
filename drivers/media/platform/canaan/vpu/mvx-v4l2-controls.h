...
#define V4L2_BUF_FRAME_FLAG_ROTATION_90 \
	0x01000000 /* Frame is rotated 90 degrees */
#define V4L2_BUF_FRAME_FLAG_ROTATION_180 \
	0x02000000 /* Frame is rotated 180 degrees */
#define V4L2_BUF_FRAME_FLAG_ROTATION_270 \
...
#define V4L2_BUF_FRAME_FLAG_SCALING_4 \
	0x08000000 /* Frame is scaled by quarter */
...
#define V4L2_BUF_ENCODE_FLAG_ROTATION_90 \
	0x10000000 /* Frame is rotated 90 degrees */
#define V4L2_BUF_ENCODE_FLAG_ROTATION_180 \
	0x20000000 /* Frame is rotated 180 degrees */
#define V4L2_BUF_ENCODE_FLAG_ROTATION_270 \
	0x30000000 /* Frame is rotated 270 degrees */
#define V4L2_BUF_ENCODE_FLAG_ROTATION_MASK 0x30000000

#define V4L2_BUF_FLAG_MVX_BUFFER_ROI \
	0x04000000 /* this buffer has a roi region */
...
struct v4l2_buffer_param_region {
	...
	short qp_delta;
	/* < QP delta value. This region will be encoded
...
#define V4L2_MAX_FRAME_CHANGE_RECTANGLES 2
	struct v4l2_buffer_param_rectangle
		rectangle[V4L2_MAX_FRAME_CHANGE_RECTANGLES];
};
...
struct v4l2_osd_config {
	...
	struct v4l2_mvx_osd_cfg osd_single_cfg
		[V4L2_MAX_FRAME_OSD_REGION]; /* include single osd region config and index */
};
...
#define VIDIOC_G_MVX_COLORDESC \
	_IOWR('V', BASE_VIDIOC_PRIVATE, struct v4l2_mvx_color_desc)
#define VIDIOC_S_MVX_ROI_REGIONS \
	_IOWR('V', BASE_VIDIOC_PRIVATE + 1, struct v4l2_mvx_roi_regions)
#define VIDIOC_S_MVX_QP_EPR \
	_IOWR('V', BASE_VIDIOC_PRIVATE + 2, struct v4l2_buffer_param_qp)
#define VIDIOC_S_MVX_COLORDESC \
	_IOWR('V', BASE_VIDIOC_PRIVATE + 3, struct v4l2_mvx_color_desc)
#define VIDIOC_S_MVX_SEI_USERDATA \
	_IOWR('V', BASE_VIDIOC_PRIVATE + 4, struct v4l2_sei_user_data)
#define VIDIOC_S_MVX_RATE_CONTROL \
	_IOWR('V', BASE_VIDIOC_PRIVATE + 5, struct v4l2_rate_control)
#define VIDIOC_S_MVX_DSL_FRAME \
	_IOWR('V', BASE_VIDIOC_PRIVATE + 6, struct v4l2_mvx_dsl_frame)
#define VIDIOC_S_MVX_DSL_RATIO \
	_IOWR('V', BASE_VIDIOC_PRIVATE + 7, struct v4l2_mvx_dsl_ratio)
#define VIDIOC_S_MVX_LONG_TERM_REF \
	_IOWR('V', BASE_VIDIOC_PRIVATE + 8, struct v4l2_mvx_long_term_ref)
#define VIDIOC_S_MVX_DSL_MODE _IOWR('V', BASE_VIDIOC_PRIVATE + 9, int)
#define VIDIOC_S_MVX_MINI_FRAME_HEIGHT _IOWR('V', BASE_VIDIOC_PRIVATE + 10, int)
#define VIDIOC_S_MVX_STATS_MODE \
	_IOWR('V', BASE_VIDIOC_PRIVATE + 11, struct v4l2_buffer_param_enc_stats)
#define VIDIOC_S_MVX_CHR_CFG \
	_IOWR('V', BASE_VIDIOC_PRIVATE + 12, struct v4l2_mvx_chr_config)
#define VIDIOC_S_MVX_HUFF_TABLE \
	_IOWR('V', BASE_VIDIOC_PRIVATE + 13, struct v4l2_mvx_huff_table)
#define VIDIOC_S_MVX_SEAMLESS_TARGET \
	_IOWR('V', BASE_VIDIOC_PRIVATE + 14, struct v4l2_mvx_seamless_target)
#define VIDIOC_S_MVX_COLOR_CONV_COEF \
	_IOWR('V', BASE_VIDIOC_PRIVATE + 15, struct v4l2_mvx_color_conv_coef)
#define VIDIOC_S_MVX_ENC_SRC_CROP \
...
#define VIDIOC_S_MVX_RGB2YUV_COLOR_CONV_COEF \
	_IOWR('V', BASE_VIDIOC_PRIVATE + 18, \
	      struct v4l2_mvx_rgb2yuv_color_conv_coef)
#define VIDIOC_S_MVX_OSD_CONFIG \
	_IOWR('V', BASE_VIDIOC_PRIVATE + 19, struct v4l2_osd_config)
#define VIDIOC_S_MVX_OSD_INFO \
	_IOWR('V', BASE_VIDIOC_PRIVATE + 20, struct v4l2_osd_info)
/****************************************************************************
 * Custom controls
 ****************************************************************************/
...
/* block configuration uncompressed rows header.
 * this configures the size of the uncompressed body.
 */
...
struct v4l2_buffer_general_rows_uncomp_body {
		 ...
		 */
	struct v4l2_block_param_record bpr[2];
};
