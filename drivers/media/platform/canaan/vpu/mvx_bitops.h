 ...
 * agains overflow.
 */
static inline void mvx_set_bit(unsigned int bit, uint64_t *addr)
{
	*addr |= 1ull << bit;
}
 ...
 * agains overflow.
 */
static inline void mvx_clear_bit(unsigned int bit, uint64_t *addr)
{
	*addr &= ~(1ull << bit);
}
 ...
 * agains overflow.
 */
static inline bool mvx_test_bit(unsigned int bit, uint64_t *addr)
{
