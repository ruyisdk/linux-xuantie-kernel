 ...
 * V4L2_BUF_FLAG_ERROR
 */
void mvx_v4l2_buffer_set_status(struct mvx_v4l2_buffer *vbuf, uint32_t status);
 ...
 * @b:        Source Vb2 buffer.
 *
 * Copies and validates parameters from 'b' to 'vbuf'.
 *
 * Return: 0 on success, else error code.
 */
 ...
 */
void mvx_v4l2_buffer_get(struct mvx_v4l2_buffer *vbuf, struct v4l2_buffer *b);
