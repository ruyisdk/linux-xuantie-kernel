...
struct mve_comm_area_host {
	 ...
	 * a mve_msg_header
	 */
	uint32_t in_data[MVE_COMM_QUEUE_SIZE_IN_WORDS];
};
 ...
 * host/driver to the firmware:
 * Code:     Extra data in message:
 */
...
#define MVE_REQUEST_CODE_SET_OPTION \
	(1010) /* struct mve_request_set_option (variable size) */
#define MVE_REQUEST_CODE_RELEASE_REF_FRAME \
	(1011) /* struct mve_request_release_ref_frame */
#define MVE_REQUEST_CODE_IDLE_ACK (1012) /* no extra data */
#define MVE_REQUEST_CODE_DEBUG \
	(1013) /* level: 0 for disable, refer to fw_log_level */
/* RESPONSEs are messages from the firmware to the host: */
#define MVE_RESPONSE_CODE_SWITCHED_IN \
	(2001) /* struct mve_response_switched_in */
#define MVE_RESPONSE_CODE_SWITCHED_OUT \
	(2002) /* struct mve_response_switched_out */
#define MVE_RESPONSE_CODE_SET_OPTION_CONFIRM (2003) /* no extra data */
#define MVE_RESPONSE_CODE_JOB_DEQUEUED \
	(2004) /* struct mve_response_job_dequeued */
#define MVE_RESPONSE_CODE_INPUT \
	(2005) /* no extra data, but buffer placed in buffer queue */
#define MVE_RESPONSE_CODE_OUTPUT \
	(2006) /* no extra data, but buffer placed in buffer queue */
...
#define MVE_RESPONSE_CODE_STATE_CHANGE \
	(2011) /* struct mve_response_state_change */
#define MVE_RESPONSE_CODE_DUMP (2012) /* no extra data */
#define MVE_RESPONSE_CODE_IDLE (2013) /* no extra data */
#define MVE_RESPONSE_CODE_FRAME_ALLOC_PARAM \
	(2014) /* struct mve_response_frame_alloc_parameters */
#define MVE_RESPONSE_CODE_SEQUENCE_PARAMETERS \
	(2015) /* struct mve_response_sequence_parameters */
#define MVE_RESPONSE_CODE_EVENT \
	(2016) /* struct mve_response_event (variable size) */
#define MVE_RESPONSE_CODE_SET_OPTION_FAIL \
...
/* BUFFERs are sent from host to firmware, and then return at some time: */
...
#define MVE_SET_OPT_INDEX_STREAM_ESCAPING \
	(2) /* arg=1 to enable (default), arg=0 to disable */
#define MVE_SET_OPT_INDEX_PROFILE_LEVEL (3) /* data.profile_level */
#define MVE_SET_OPT_INDEX_HOST_PROTOCOL_PRINTS \
	(4) /* arg=1 to enable, arg=0 to disable (default) */
#define MVE_SET_OPT_INDEX_PROFILING \
	(5) /* arg=1 to enable, arg=0 to disable (default) */
#define MVE_SET_OPT_INDEX_DISABLE_FEATURES \
	(6) /* see arg, MVE_OPT_DISABLE_FEATURE_ */
#define MVE_SET_OPT_INDEX_IGNORE_STREAM_HEADERS \
	(7) /* decode, arg=1 to enable, arg=0 to disable (default) */
#define MVE_SET_OPT_INDEX_FRAME_REORDERING \
	(8) /* decode, arg=1 to enable (default), arg=0 to disable */
#define MVE_SET_OPT_INDEX_INTBUF_SIZE \
	(9) /* decode, arg = suggested limit of intermediate buffer allocation */
#define MVE_SET_OPT_INDEX_ENC_P_FRAMES (16) /* encode, arg = nPFrames */
#define MVE_SET_OPT_INDEX_ENC_B_FRAMES \
	(17) /* encode, arg = number of B frames */
...
#define MVE_SET_OPT_INDEX_ENC_MIN_LUMA_CB_SIZE \
	(24) /* HEVC encode, arg = 8 or 16, for sizes 8x8 or 16x16 */
...
#define MVE_SET_OPT_INDEX_ENC_H264_CABAC \
	(27) /* encode, arg = 0 or 1, enabled by default */
#define MVE_SET_OPT_INDEX_ENC_SLICE_SPACING \
	(28) /* encode, arg = suggested number of CTUs/macroblocks in a slice */
#define MVE_SET_OPT_INDEX_ENC_VP9_PROB_UPDATE (30) /* VP9 encode, see arg */
#define MVE_SET_OPT_INDEX_RESYNC_INTERVAL \
	(31) /* JPEG encode, arg = nRestartInterval = nResynchMarkerSpacing */
#define MVE_SET_OPT_INDEX_HUFFMAN_TABLE \
	(32) /* JPEG encode, data.huffman_table */
#define MVE_SET_OPT_INDEX_QUANT_TABLE (33) /* JPEG encode, data.quant_table */
#define MVE_SET_OPT_INDEX_ENC_EXPOSE_REF_FRAMES \
	(34) /* encode debug, arg = 0 or 1, disabled by default */
#define MVE_SET_OPT_INDEX_MBINFO_OUTPUT \
	(35) /* encode, arg=1 to enable, arg=0 to disable (default) */
#define MVE_SET_OPT_INDEX_MV_SEARCH_RANGE \
	(36) /* encode, data,motion_vector_search_range */
#define MVE_SET_OPT_INDEX_ENC_STREAM_BITDEPTH \
	(38)
	/* encode, data.bitdepth, to set other bitdepth of encoded stream than of input frames */
#define MVE_SET_OPT_INDEX_ENC_STREAM_CHROMA_FORMAT \
	(39) /* encode, arg, to set other chroma format of encoded stream than of input frames */
#define MVE_SET_OPT_INDEX_ENC_RGB_TO_YUV_MODE \
	(40) /* encode, arg, select which way RGB is converted to YUV before encoding */
#define MVE_SET_OPT_INDEX_ENC_BANDWIDTH_LIMIT \
	(41) /* encode, arg, the maximum bandwidth limit defined by host */
#define MVE_SET_OPT_INDEX_WATCHDOG_TIMEOUT \
	(42) /* arg=timeout, arg=0 to disable */
#define MVE_SET_OPT_INDEX_ENC_CABAC_INIT_IDC \
	(43) /* encode, arg; 0,1,2 for H264; 0,1 for HEVC */
#define MVE_SET_OPT_INDEX_ENC_ADPTIVE_QUANTISATION \
	(44) /* encode (h264 and hevc) */
...
#define MVE_SET_OPT_INDEX_DEC_DOWNSCALE \
	(57) /* decode, set downscaled width and height */
/* SAO_EVAL */
...
#define MVE_SET_OPT_iNDEX_ENC_VISUAL_ENABLE \
	(89) //enable_visual FW CODE IS iNDEX
/* SVCT3 level-1 separate */
#define MVE_SET_OPT_INDEX_ENC_SVCT3_LEVEL1_separate (88)
/* GDR */
...
/* For option MVE_SET_OPT_INDEX_NALU_FORMAT, arg should be one of these: */
...
/* For option MVE_SET_OPT_INDEX_GOP_TYPE, arg should be one of these: */
...
/* For option MVE_SET_OPT_INDEX_ENC_VP9_PROB_UPDATE, arg should be one of these: */
...
/* For option MVE_SET_OPT_INDEX_DISABLE_FEATURES,
 * arg should be a bitmask with features to disable:
 */
#define MVE_OPT_DISABLE_FEATURE_AFBC_COMP \
	(0x00000001) /* VDMA AFBC Compression   */
#define MVE_OPT_DISABLE_FEATURE_REF_CACHE \
	(0x00000002) /* REF caching             */
#define MVE_OPT_DISABLE_FEATURE_DEBLOCK \
	(0x00000004) /* Deblocking              */
#define MVE_OPT_DISABLE_FEATURE_SAO (0x00000008) /* SAO                     */
#define MVE_OPT_DISABLE_FEATURE_PIC_OUTPUT \
	(0x00000020) /* Picture Output Removal  */
#define MVE_OPT_DISABLE_FEATURE_PIPE (0x00000040) /* Pipe (i.e. parser-only) */
#define MVE_OPT_DISABLE_FEATURE_SLEEP \
	(0x00000080) /* Clock gating (SOC_SYSCTRL.SLEEP bit) */
#define MVE_OPT_DISABLE_FEATURE_AFBC_LEGACY_REF \
	(0x00000100)
	/* Enables tiled AFBC format in reference buffers. Ignored for decode AFBC output */
#define MVE_OPT_DISABLE_FEATURE_REF_PICS \
	(0x00000400) /* Forces use of static 16x16 reference pics */
#define MVE_OPT_DISABLE_FEATURE_CHNG_RECT_WA \
	(0x00000800) /* Disables workaround */
#define MVE_OPT_DISABLE_FEATURE_REFSZ_LIMIT \
	(0x00001000) /* Disable REFSZ bw limit */
...
/* For option MVE_SET_OPT_INDEX_ENC_RGB_TO_YUV_MODE, arg should be one of these: */
 ...
 */
#define MVE_OPT_LEVEL_H264_USER_SUPPLIED_MAX \
	(MVE_OPT_LEVEL_H264_USER_SUPPLIED_BASE + 255)
/* HEVC/H.265 levels */
...
#define MVE_OPT_QUANT_TABLE_CHROMA (2)
		...
		struct {
			/* For HEVC, tile_cols must be zero.
			 * For VP9, tile_rows and tile_cols must be powers of 2.
			 */
			uint16_t tile_rows;
			uint16_t tile_cols;
		} tiles;
...
struct mve_response_frame_alloc_parameters {
	 ...
	 * the afbc_width_in_superblocks to be at least this recommended value.
...
#define MVE_CHROMA_FORMAT_OSD_ARGB (0x7)
	...
	/* number of AFBC buffers needed, for
	...
	/* VC-1 AP specific feature, if enabled
...
struct mve_event_processed {
	...
	uint32_t parse_idle_time;
	/* Definition of idle here is waiting for in/out buffers or available RAM */

	uint32_t pipe_start_time; /* Timestamp */
	uint32_t pipe_end_time;
	/* Timestamp, end-start = process time. Idle time while in a frame is not measured. */
	...
	uint32_t intermediate_buffer_size;
	/* Size of intermediate (mbinfo/residuals) buffer after this frame was parsed. */
	uint32_t total_memory_allocated;
	/* after the frame was parsed. Including reference frames. */
 ...
 *
 * MVE_BUFFER_FRAME_FLAG_MIRROR_*       -       host   Input frame should be mirrored
 *                                                     before encoding
 *
 * MVE_BUFFER_FRAME_FLAG_REJECTED       fw      -      Buffer was too small,
 *                                                     host should re-allocate
 *
 ...
 *
 * MVE_BUFFER_FRAME_FLAG_REF_FRAME      fw      -      Frame is used by MVE as reference,
 *                                                     host must not change,
 *                                                     just re-enqueue when displayed
...
struct mve_buffer_frame_afbc {
	uint32_t plane[2];
	/* Addresses for up to two AFBC planes: Top and bottom fields for interlace,
	...
	uint16_t afbc_width_in_superblocks[2];
		/* Width of AFBC frame buffer, in units
...
#define MVE_BUFFER_FRAME_AFBC_TILED_BODY \
	(0x00000001) /* Output body blocks should be tiled */
#define MVE_BUFFER_FRAME_AFBC_TILED_HEADER \
	(0x00000002) /* Output headers should be tiled */
#define MVE_BUFFER_FRAME_AFBC_32X8_SUPERBLOCK \
	(0x00000004)
	/* Super block is 32x8, default is 16x16, (only supported as input for encode) */
#define MVE_BUFFER_FRAME_AFBC_DN_FORCE_8BIT \
	(0x00000008)
	/* For downscaled AFBC plane: It shall be 8-bit, even if full-scale is 10-bit */
#define MVE_BUFFER_FRAME_AFBC_DN_FORCE_420 \
	(0x00000010)
	/* For downscaled AFBC plane: It shall be 4:2:0, even if full-scale is 4:2:2 */
#define MVE_BUFFER_FRAME_AFBC_STRIDE_SET_BY_MVE \
	(0x00000020)
	/* Decode only: By default, the host should
...
#define MVE_BUFFER_FRAME_FLAG_RESET_LTR_separate (0x00020000)
/*ARBITRARY_DOWNSCALE*/
...
/* formats: */
#define MVE_FORMAT_YUV420_AFBC_8                      \
	((MVE_CHROMA_FORMAT_420 << MVE_FORMAT_BF_C) | \
	 ((8 - 8) << MVE_FORMAT_BF_B) | (1 << MVE_FORMAT_BF_A))

#define MVE_FORMAT_YUV420_AFBC_10                     \
	((MVE_CHROMA_FORMAT_420 << MVE_FORMAT_BF_C) | \
	 ((10 - 8) << MVE_FORMAT_BF_B) | (1 << MVE_FORMAT_BF_A))

#define MVE_FORMAT_YUV422_AFBC_8                      \
	((MVE_CHROMA_FORMAT_422 << MVE_FORMAT_BF_C) | \
	 ((8 - 8) << MVE_FORMAT_BF_B) | (1 << MVE_FORMAT_BF_A))

#define MVE_FORMAT_YUV422_AFBC_10                     \
	((MVE_CHROMA_FORMAT_422 << MVE_FORMAT_BF_C) | \
	 ((10 - 8) << MVE_FORMAT_BF_B) | (1 << MVE_FORMAT_BF_A))

#define MVE_FORMAT_YUV420_I420                                   \
	((MVE_CHROMA_FORMAT_420 << MVE_FORMAT_BF_C) |            \
	 ((8 - 8) << MVE_FORMAT_BF_B) | (3 << MVE_FORMAT_BF_N) | \
	 (0 << MVE_FORMAT_BF_V))

#define MVE_FORMAT_YUV420_I420_10                                 \
	((MVE_CHROMA_FORMAT_420 << MVE_FORMAT_BF_C) |             \
	 ((10 - 8) << MVE_FORMAT_BF_B) | (3 << MVE_FORMAT_BF_N) | \
	 (0 << MVE_FORMAT_BF_V))

#define MVE_FORMAT_YUV420_NV12                                   \
	((MVE_CHROMA_FORMAT_420 << MVE_FORMAT_BF_C) |            \
	 ((8 - 8) << MVE_FORMAT_BF_B) | (2 << MVE_FORMAT_BF_N) | \
	 (0 << MVE_FORMAT_BF_V))

#define MVE_FORMAT_YUV420_NV21                                   \
	((MVE_CHROMA_FORMAT_420 << MVE_FORMAT_BF_C) |            \
	 ((8 - 8) << MVE_FORMAT_BF_B) | (2 << MVE_FORMAT_BF_N) | \
	 (1 << MVE_FORMAT_BF_V))

#define MVE_FORMAT_YUV420_P010                                    \
	((MVE_CHROMA_FORMAT_420 << MVE_FORMAT_BF_C) |             \
	 ((16 - 8) << MVE_FORMAT_BF_B) | (2 << MVE_FORMAT_BF_N) | \
	 (0 << MVE_FORMAT_BF_V))

#define MVE_FORMAT_YUV420_2P_10                                   \
	((MVE_CHROMA_FORMAT_420 << MVE_FORMAT_BF_C) |             \
	 ((10 - 8) << MVE_FORMAT_BF_B) | (2 << MVE_FORMAT_BF_N) | \
	 (0 << MVE_FORMAT_BF_V))

#define MVE_FORMAT_YUV420_Y0L2                                    \
	((MVE_CHROMA_FORMAT_420 << MVE_FORMAT_BF_C) |             \
	 ((10 - 8) << MVE_FORMAT_BF_B) | (1 << MVE_FORMAT_BF_N) | \
	 (0 << MVE_FORMAT_BF_V))

#define MVE_FORMAT_YUV420_AQB1                                    \
	((MVE_CHROMA_FORMAT_420 << MVE_FORMAT_BF_C) |             \
	 ((10 - 8) << MVE_FORMAT_BF_B) | (1 << MVE_FORMAT_BF_N) | \
	 (1 << MVE_FORMAT_BF_V))

#define MVE_FORMAT_YUV422_YUY2                                   \
	((MVE_CHROMA_FORMAT_422 << MVE_FORMAT_BF_C) |            \
	 ((8 - 8) << MVE_FORMAT_BF_B) | (1 << MVE_FORMAT_BF_N) | \
	 (0 << MVE_FORMAT_BF_V))

#define MVE_FORMAT_YUV422_UYVY                                   \
	((MVE_CHROMA_FORMAT_422 << MVE_FORMAT_BF_C) |            \
	 ((8 - 8) << MVE_FORMAT_BF_B) | (1 << MVE_FORMAT_BF_N) | \
	 (1 << MVE_FORMAT_BF_V))

#define MVE_FORMAT_YUV422_Y210                                    \
	((MVE_CHROMA_FORMAT_422 << MVE_FORMAT_BF_C) |             \
	 ((16 - 8) << MVE_FORMAT_BF_B) | (1 << MVE_FORMAT_BF_N) | \
	 (0 << MVE_FORMAT_BF_V))

#define MVE_FORMAT_YUV422_1P_10                                   \
	((MVE_CHROMA_FORMAT_422 << MVE_FORMAT_BF_C) |             \
	 ((10 - 8) << MVE_FORMAT_BF_B) | (1 << MVE_FORMAT_BF_N) | \
	 (0 << MVE_FORMAT_BF_V))

#define MVE_FORMAT_RGBA_8888                                     \
	((MVE_CHROMA_FORMAT_ARGB << MVE_FORMAT_BF_C) |           \
	 ((8 - 8) << MVE_FORMAT_BF_B) | (1 << MVE_FORMAT_BF_N) | \
	 (0 << MVE_FORMAT_BF_V))

#define MVE_FORMAT_BGRA_8888                                     \
	((MVE_CHROMA_FORMAT_ARGB << MVE_FORMAT_BF_C) |           \
	 ((8 - 8) << MVE_FORMAT_BF_B) | (1 << MVE_FORMAT_BF_N) | \
	 (1 << MVE_FORMAT_BF_V))

#define MVE_FORMAT_ARGB_8888                                     \
	((MVE_CHROMA_FORMAT_ARGB << MVE_FORMAT_BF_C) |           \
	 ((8 - 8) << MVE_FORMAT_BF_B) | (1 << MVE_FORMAT_BF_N) | \
	 (2 << MVE_FORMAT_BF_V))

#define MVE_FORMAT_ABGR_8888                                     \
	((MVE_CHROMA_FORMAT_ARGB << MVE_FORMAT_BF_C) |           \
	 ((8 - 8) << MVE_FORMAT_BF_B) | (1 << MVE_FORMAT_BF_N) | \
	 (3 << MVE_FORMAT_BF_V))
#define MVE_FORMAT_Y                                             \
	((MVE_CHROMA_FORMAT_MONO << MVE_FORMAT_BF_C) |           \
	 ((8 - 8) << MVE_FORMAT_BF_B) | (1 << MVE_FORMAT_BF_N) | \
	 (0 << MVE_FORMAT_BF_V))
#define MVE_FORMAT_Y_10                                           \
	((MVE_CHROMA_FORMAT_MONO << MVE_FORMAT_BF_C) |            \
	 ((10 - 8) << MVE_FORMAT_BF_B) | (1 << MVE_FORMAT_BF_N) | \
	 (0 << MVE_FORMAT_BF_V))

#define MVE_FORMAT_RGB_888                                       \
	((MVE_CHROMA_FORMAT_RGB << MVE_FORMAT_BF_C) |            \
	 ((8 - 8) << MVE_FORMAT_BF_B) | (1 << MVE_FORMAT_BF_N) | \
	 (0 << MVE_FORMAT_BF_V))

#define MVE_FORMAT_BGR_888                                       \
	((MVE_CHROMA_FORMAT_RGB << MVE_FORMAT_BF_C) |            \
	 ((8 - 8) << MVE_FORMAT_BF_B) | (1 << MVE_FORMAT_BF_N) | \
	 (1 << MVE_FORMAT_BF_V))

#define MVE_FORMAT_RGB_3P                                        \
	((MVE_CHROMA_FORMAT_RGB << MVE_FORMAT_BF_C) |            \
	 ((8 - 8) << MVE_FORMAT_BF_B) | (3 << MVE_FORMAT_BF_N) | \
	 (0 << MVE_FORMAT_BF_V))
#define MVE_FORMAT_YUV444                                        \
	((MVE_CHROMA_FORMAT_444 << MVE_FORMAT_BF_C) |            \
	 ((8 - 8) << MVE_FORMAT_BF_B) | (3 << MVE_FORMAT_BF_N) | \
	 (0 << MVE_FORMAT_BF_V))
#define MVE_FORMAT_YUV444_10                                      \
	((MVE_CHROMA_FORMAT_444 << MVE_FORMAT_BF_C) |             \
	 ((10 - 8) << MVE_FORMAT_BF_B) | (3 << MVE_FORMAT_BF_N) | \
	 (0 << MVE_FORMAT_BF_V))
#define MVE_FORMAT_ARGB_1555                                     \
	((MVE_CHROMA_FORMAT_OSD_ARGB << MVE_FORMAT_BF_C) |       \
	 ((8 - 8) << MVE_FORMAT_BF_B) | (1 << MVE_FORMAT_BF_N) | \
	 (0 << MVE_FORMAT_BF_V))
#define MVE_FORMAT_ARGB_4444                                     \
	((MVE_CHROMA_FORMAT_OSD_ARGB << MVE_FORMAT_BF_C) |       \
	 ((8 - 8) << MVE_FORMAT_BF_B) | (1 << MVE_FORMAT_BF_N) | \
	 (1 << MVE_FORMAT_BF_V))
#define MVE_FORMAT_RGB_565                                       \
	((MVE_CHROMA_FORMAT_OSD_ARGB << MVE_FORMAT_BF_C) |       \
	 ((8 - 8) << MVE_FORMAT_BF_B) | (1 << MVE_FORMAT_BF_N) | \
	 (2 << MVE_FORMAT_BF_V))
...
#define MVE_FORMAT_UNUSED (0x0000)
	...
	uint8_t frame_flags_ext; /* add osd buffer tag to separate osd & source */
...
struct mve_buffer_param_region {
	...
	int16_t qp_delta;
	/* QP delta value for this region, this
	...
	uint8_t force_intra;
	/* force intra to this ROI region, refer to macro: FEATURE_SUPPORT_ROI_MISC */
};
...
struct mve_buffer_general_rows_uncomp_body {
	 ...
	 */
	struct mve_block_param_record bpr[2];
};
...
struct mve_reset_ltr_separate_dynamic {
	uint32_t reset_ltr_separate_pframes;
};
...
#define MVE_MAX_FRAME_CHANGE_RECTANGLES 2
	struct mve_buffer_param_rectangle
		rectangles[MVE_MAX_FRAME_CHANGE_RECTANGLES];
};

struct t_mve_buffer_param_osd_cfg {
	...
	uint8_t osd_inside_convert_color_threshold;
	/* threshold range [0~255], if input is 10bit, th * 4 */
...
struct mve_buffer_param_osd_rectangles {
	...
	struct t_mve_buffer_param_osd_cfg osd_single_cfg[MVE_MAX_FRAME_OSD_REGION];
};
...
#define MVE_BUFFER_PARAM_TYPE_FRAME_RATE \
	(9)
	/* arg, in frames per second, as a fixed point Q16 value,
	 * for example 0x001e0000 == 30.0 fps
	 */
#define MVE_BUFFER_PARAM_TYPE_RATE_CONTROL (10) /* rate_control */
#define MVE_BUFFER_PARAM_TYPE_QP_I \
	(12) /* qp for I frames, when no rate control */
#define MVE_BUFFER_PARAM_TYPE_QP_P \
	(13) /* qp for P frames, when no rate control */
#define MVE_BUFFER_PARAM_TYPE_QP_B \
	(14) /* qp for B frames, when no rate control */
...
#define MVE_BUFFER_PARAM_TYPE_DPB_HELD_FRAMES \
	(19)
	/* arg, number of output buffers that are complete and held by firmware
	 * in the DPB for reordering purposes. Valid after the next frame is output
	 */
#define MVE_BUFFER_PARAM_TYPE_CHANGE_RECTANGLES (20) /* change rectangles */
#define MVE_BUFFER_PARAM_TYPE_RATE_CONTROL_QP_RANGE \
	(21) /* rate_control_qp_range */
#define MVE_BUFFER_PARAM_TYPE_RATE_CONTROL_HRD_BUF_SIZE (23) /* arg */
#define MVE_BUFFER_PARAM_TYPE_RATE_CONTROL_QP_RANGE_I \
	(25) /* special range for I frames, ate_control_qp_range */
#define MVE_BUFFER_PARAM_TYPE_SEI_USER_DATA_UNREGISTERED \
	(26) /* sei user_data_unregistered */
#define MVE_BUFFER_PARAM_TYPE_GOP_RESET_DYNAMIC (27)
#define MVE_BUFFER_PARAM_TYPE_GOP_RESET_LTR_separate_DYNAMIC \
	(28) /* reset ltr separate dynamiclly */
...
#define MVE_BUFFER_PARAM_TYPE_RATE_CONTROL_CHANGE_POS (31)
	...
	union {
		...
		struct mve_reset_ltr_separate_dynamic reset_ltr_separate_dynamic;
